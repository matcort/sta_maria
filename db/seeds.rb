...
21.times do |i|
     ...
     #   estado=true
    #end
    Local.create(direccion:"Santa María 347", numero: i+2, estadoArriendo: false)
end
...
Contrato.create(fechaInicio: Faker::Date.forward(23), fechaFin:Faker::Date.forward(23), montoArriendo:Faker::Number.number(6), documento: "asd", estado:true, arrendatario_id: n, administrador_id:1, local_id: n)
end
...
Gasto.create(local_id: 1, nombre: "Gasto1", monto:5000)
Gasto.create(local_id: 1, nombre: "Gasto2", monto:4000)