...
class AdministradorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create administrador" do
    assert_difference('Administrador.count') do
      post administradors_url, params: { administrador: { jer: @administrador.jer, mail: @administrador.mail, nombre: @administrador.nombre, password_digest: @administrador.password_digest, rut: @administrador.rut, telefono: @administrador.telefono } }
    end
  ...
  test "should update administrador" do
    patch administrador_url(@administrador), params: { administrador: { jer: @administrador.jer, mail: @administrador.mail, nombre: @administrador.nombre, password_digest: @administrador.password_digest, rut: @administrador.rut, telefono: @administrador.telefono } }
