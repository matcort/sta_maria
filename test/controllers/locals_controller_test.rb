...
class LocalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create local" do
    assert_difference('Local.count') do
      post locals_url, params: { local: { comentarios: @local.comentarios, direccion: @local.direccion, estadoArriendo: @local.estadoArriendo, numero: @local.numero } }
    end
  ...
  test "should update local" do
    patch local_url(@local), params: { local: { comentarios: @local.comentarios, direccion: @local.direccion, estadoArriendo: @local.estadoArriendo, numero: @local.numero } }
